...
export default {
  data () {
    return {
      mediaType: 'movie',
      componentId: 'trendingMovies',
      trendingUrl: `https://api.themoviedb.org/3/trending/all/day?api_key=${process.env.API_SECRET}&language=en-US&region=us`,
      currentPage: 1,
      nextPage: 0,
      totalPages: 1,
      results: []
  ...
  methods: {
    ...
    updatePage () {
      if (this.currentPage === this.nextPage) {
        ...
        this.opts = cfg.renderObject(`${this.trending}&page=${this.currentPage}`, this.componentId)
        this.loadtrending()
      }
    }
  }
